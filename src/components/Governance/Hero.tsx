      ...
      <div className="lg:hidden">
        ...
        <div className="flex flex-col">
          ...
          <div className="p-4 md:p-6 flex items-center justify-center">
            <Image src={clip} alt="Metallic sculpture" quality={100} className="w-[200px] md:w-[250px]" />
          </div>
          ...
          <div className="flex flex-col">
            {teamMembers.map((member, index) => (
              <div key={member.name} className="flex items-center justify-center p-4 md:p-6 border-b border-black last:border-b-0">
                <Link
                  href={member.link}
                  target="_blank"
          ...
          <div className="flex flex-col space-y-4 p-4 md:p-6">
            ...
            <div className="">
              <Link
                ...
                rel="noopener noreferrer"
              >
                <div className="rounded-full p-4 flex items-center justify-center gap-4 shadow-lg bg-white cursor-pointer transition-all duration-300 hover:scale-105">
                  <Image
                    src={arbitrum}
                    alt="arbitrum"
            ...
            <div className="">
              ...
              >
                <div className="rounded-full p-4 flex items-center justify-center gap-4 shadow-lg bg-white cursor-pointer transition-all duration-300 hover:scale-105">
                  <Image src={op} alt="optimism" className="w-8 md:w-10" quality={100} />
                  <Typography
                    variant="subtitle2"
                    color="primary"
                    weight="semibold"
